  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="max-w-4xl w-full text-center">
        ...
        >
          ...
          >
            <svg 
              ...
              viewBox="0 0 200 200" 
              className="w-48 h-48 mx-auto text-gold-300"
            >
              <path 
                fill="currentColor" 
        ...
        <motion.h1
          className="text-8xl md:text-9xl font-heading font-bold text-gold-500 mb-4"
        ...
        >
          <button
            ...
            className="px-8 py-3 bg-gold-500 text-white rounded-lg hover:bg-gold-600 transition-colors"
          >
            Go Back
          </button>
          <Link 
            href="/" 
            className="px-8 py-3 bg-white text-gold-500 border border-gold-500 rounded-lg hover:bg-gold-50 transition-colors"
          >
            Go Home
          </Link>
        </motion.div>
