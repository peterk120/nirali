      ...
      <div className="max-w-2xl w-full text-center">
        ...
        >
          ...
          >
            <button
              onClick={() => reset()}
              className="px-6 py-3 bg-plum-500 text-white rounded-lg hover:bg-plum-600 transition-colors"
            >
              Try Again
            </button>
            <Link 
              href="/" 
              className="px-6 py-3 bg-white text-plum-500 border border-plum-500 rounded-lg hover:bg-plum-50 transition-colors"
            >
              Go Home
            </Link>
          </motion.div>
