  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="max-w-4xl w-full text-center">
        ...
        >
          ...
          >
            <svg 
              ...
              viewBox="0 0 200 200" 
              className="w-48 h-48 mx-auto text-teal-300"
            >
              <path 
                fill="currentColor" 
        ...
        <motion.h1
          className="text-8xl md:text-9xl font-heading font-bold text-teal-500 mb-4"
        ...
        >
          ...
          <Link 
            href="/" 
            className="px-8 py-3 bg-white text-teal-500 border border-teal-500 rounded-lg hover:bg-teal-50 transition-colors"
          >
            Go Home
          </Link>
        </motion.div>
